...
<template>
  <div class="fixed w-full h-screen bg-black">
    <div v-if="!showFullVideo" id="SideNav" class="flex z-40 items-center w-[120px] h-screen bg-black relative">
      <img src="../public/images/netflix-logo.png" class="absolute top-0 w-[35px] mt-10 ml-10">
      <div>
    ...
    <div v-if="!showFullVideo">
      <div class="fixed flex z-20 top-0 right-0 w-full h-[50%] bg-black pl-[120px] bg-clip-border">
        ...
        <div class="absolute z-30 h-[600px] left-[350px] w-[77%] right-0 top-0 bg-gradient-to-r from-black via-black" />

        <MovieDetails v-if="movie" :movie="movie" />
        
        <video 
          v-if="movie"
          :src="'../public/videos/' + movie.name + '.mp4'"
          autoplay
          muted
          loop
    ...
    <div v-if="!showFullVideo" class="absolute z-20 h-[70%] left-[350px] w-[100%] right-0 bottom-0 bg-gradient-to-t from-black via-black" />
